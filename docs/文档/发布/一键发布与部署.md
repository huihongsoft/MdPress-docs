...
layout: 
title: 一键发布与部署
slug: one-click-publish-and-deploy
tag: [发布, 自动化]
description: 介绍 MdPress 的一键发布功能，支持自动同步源码并部署到 GitHub Pages 或 Gitee Pages，包含常见故障排除。
keywords: mdpress, 一键发布, github pages, gitee pages, 自动化部署
---
