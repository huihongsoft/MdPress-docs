...
layout: 
title: 导航与菜单配置
slug: navigation-and-menu-configuration
tag: [站点, 导航]
description: 详解 MdPress 导航系统配置，包括顶部导航栏 (Navbar) 和侧边栏 (Sidebar) 的自动生成与精确控制模式。
keywords: mdpress, 导航栏, 侧边栏, 菜单, 配置, sidebar, navbar
---
